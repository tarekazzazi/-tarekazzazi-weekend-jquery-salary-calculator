...
function AddEmployeeInfo() {
    ...
    let firstName = $('#firstName').val(); // gets input firstName  assigns it to variable called firstName
    let lastName = $('#lastName').val();
    let ID = $('#ID').val();
    let jobTitle = $('#jobTitle').val();
    let annuelSalary = $('#annualSalary').val();

    newEmployee = { // I tried to take in the values entered and create a object called newEmployee with them which I pushed to a array called tableEmployees.  Simular to the Object-group-bonus calculator. I had trouble getting the annual salary values from tableEmployees array.
    ...
    tableEmployees.push(newEmployee); // added newEmployee object to tableEmployees array
...
function findEmployeeSalary(employeeArray) { // takes in array of newEmployee objects and calculate the salary for each of them
